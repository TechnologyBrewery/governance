...
**2.2. Appeal Process**. Decisions may be appealed by opening an issue and that appeal will be considered by the Maintainers in good faith, who will respond in writing within a reasonable time. If the Maintainers deny the appeal, the appeal may be brought before the Technology Brewery Steering Committee, who will also respond in writing in a reasonable time.
...
Any names, trademarks, logos, or goodwill developed by and associated with the Project (the "Marks") are controlled by the Technology Brewery. Maintainers may only use these Marks in accordance with the Technology Brewery's trademark policy. If a Maintainer resigns or is removed, any rights the Maintainer may have in the Marks revert to the Technology Brewery.

## 6. Amendments.

Amendments to this governance policy may be made by affirmative vote of 2/3 of all Maintainers, with approval by the Technology Brewery's Steering Committee.
