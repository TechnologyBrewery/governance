# Charter for the Technology Brewery Organization

This is the organizational charter for the Technology Brewery Organization (the "Organization"). By adding their name to the [Steering Committee.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.

## 1. Mission

The Technology Brewery is committed to the development of high quality open source software that improves delivery velocity
while helping teams align with foundational software engineering best practices.
...
**4.2 Unreachable Member**. If a member is unresponsive at its listed handle for more than two months the Steering Committee may vote to remove the member.
